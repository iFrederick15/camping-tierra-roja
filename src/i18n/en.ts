...
export const en: Traducciones = {
  ...
  contacto: {
    ...
    metaDescripcion:
      'Phone, WhatsApp and map for Camping Tierra Roja in Puerto Iguazú, about 20 minutes from Iguazú Falls.',
    tituloDestacado: 'Contact',
    titulo: 'and how to find us',
    intro:
      'Camping Tierra Roja is at {direccion}, about 20 minutes from Iguazú Falls and from downtown Puerto Iguazú. We are open every day of the year. For availability and bookings, message us on WhatsApp or fill in the form and we will take you to WhatsApp with your message ready to send.',
