...
const es: TextosWidget = {
  ...
  unidades: {
    CAMPING: { label: 'Camping', descripcion: 'Arma tu carpa rodeado de naturaleza.' },
    MOTORHOME: { label: 'Motorhome', descripcion: 'Parcela con luz y agua para tu rodante.' },
    CABANA: { label: 'Cabaña', descripcion: 'Comodidad en plena naturaleza.' },
    QUINCHOS: { label: 'Quincho', descripcion: 'Espacio techado con parrilla para tu grupo.' },
  },
  porNoche: '/ noche',
  porDia: '/ día',
...
const pt: TextosWidget = {
  ...
  confirmar: 'Confirmar reserva',
  confirmando: 'Confirmando…',
  confirmadaTitulo: 'Reserva feita!',
...
const en: TextosWidget = {
  ...
  unidades: {
    CAMPING: { label: 'Camping', descripcion: 'Pitch your tent surrounded by nature.' },
    MOTORHOME: {
      label: 'Motorhome',
      descripcion: 'A pitch with power and water for your vehicle.',
    },
    CABANA: { label: 'Cabin', descripcion: 'Comfort deep in nature.' },
